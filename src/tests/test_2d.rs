...
type NetInfRecv = Receiver<(Vec<(Vec<f32>, Vec<f32>)>, Vec<f32>, Vec<f32>, TNetwork)>;
struct MainScreen {
    inputs: Vec<Vec<f32>>,
    outputs: Vec<Vec<f32>>,
...
impl MainScreen {
    pub unsafe fn new(window: &mut Window, inputs: Vec<Vec<f32>>, outputs: Vec<Vec<f32>>, receive: NetInfRecv, layers: Vec<(usize, usize, usize)>, network: TNetwork) -> Self {
